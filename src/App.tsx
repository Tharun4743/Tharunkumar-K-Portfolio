    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        >
          ...
          <span>
            Tharunkumar K<span className="text-slate-400">.</span>
          </span>
        </a>
...
const SectionHeader: React.FC<{
  ...
  >
    ...
    {subtitle && (
      <p className="text-slate-500 max-w-2xl text-lg font-medium ml-1 mr-auto">
        {subtitle}
      </p>
    )}
  </motion.div>
    ...
    <div className="min-h-screen bg-white selection:bg-blue-100 selection:text-blue-900">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 mb-8 leading-[1] tracking-tighter">
                Engineering{' '}
                <span className="text-blue-600 block sm:inline">Future</span>{' '}
                Solutions.
              </h1>

              <p className="text-lg md:text-2xl text-slate-600 mb-10 leading-relaxed max-w-2xl font-medium mx-auto lg:mx-0">
                Hi, I'm{' '}
                <span className="text-slate-900 font-bold underline decoration-blue-500 decoration-4 underline-offset-4">
                  {PERSONAL_INFO.name}
                </span>
                . I build intelligent web applications and IoT systems that
                ...
                <div className="flex items-center gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      link: PERSONAL_INFO.geeksforgeeks,
                      label: 'GeeksForGeeks'
                    }
                  ].map((social, i) => (
                    <motion.a
            ...
            >
              <div className="relative group max-w-[400px] w-full px-4 lg:px-0">
                <div className="absolute -inset-8 bg-blue-500/20 rounded-[4rem] blur-[50px] -z-10 group-hover:bg-blue-500/30 transition-colors" />
                <motion.div
                  animate={{ y: [0, -15, 0] }}
                  transition={{
                    duration: 5,
                  ...
                  className="w-full aspect-[4/5] bg-slate-100 rounded-[3rem] shadow-2xl relative overflow-hidden transition-all duration-700 border-[8px] border-white ring-1 ring-slate-100"
                >
                  <img
                    src={PERSONAL_INFO.profileImage}
                    alt={PERSONAL_INFO.name}
                    className="w-full h-full object-cover object-center translate-y-1 group-hover:scale-110 transition-transform duration-1000"
                    onError={(e) => {
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative aspect-square max-w-[440px] mx-auto">
                <div className="absolute inset-0 bg-blue-600 rounded-[3.5rem] rotate-6 scale-95 opacity-5" />
                <div className="absolute inset-0 bg-blue-600 rounded-[3.5rem] -rotate-3 scale-95 opacity-5" />
                <img
                  src={PERSONAL_INFO.profileImageAlt}
                  alt="Tharunkumar Portrait"
                  className="relative z-10 w-full h-full object-cover object-center rounded-[3.5rem] shadow-2xl border-[6px] border-white"
                  onError={(e) => {
                    const target = e.target as HTMLImageElement;
                    target.src =
                      'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=800&auto=format&fit=crop';
        ...
        <div className="container mx-auto px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {TECHNICAL_SKILLS.map((cat, idx) => (
              ...
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-blue-100/50 rounded-bl-full -z-10 group-hover:scale-150 transition-transform duration-1000" />
      ...
      <section id="education" className="py-32 bg-slate-50/50">
        <div className="container mx-auto px-6">
          <SectionHeader
            title="Education"
            subtitle="Academic milestones that shaped my journey."
            icon={<User size={28} />}
          />
      ...
      <section id="projects" className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <SectionHeader
            title="Projects"
            subtitle="Real-world applications built with modern tools."
            icon={<Code size={28} />}
          />
          <div className="grid lg:grid-cols-2 gap-12">
            {PROJECTS.map((project, idx) => (
              <motion.div
                ...
                className="group bg-slate-50 rounded-[3.5rem] overflow-hidden flex flex-col border border-slate-100 hover:border-blue-400 transition-all hover:shadow-3xl"
              >
                <div className="p-12 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-8">
                    ...
                    {project.link && project.link !== '#' && (
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-5 bg-white rounded-2xl shadow-sm text-slate-400 hover:text-blue-600 transition-all border border-slate-100"
                      >
                  ...
                  <div className="mt-auto flex flex-wrap gap-3">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-5 py-2.5 bg-white text-sm font-black text-slate-500 rounded-xl border border-slate-200 group-hover:border-blue-200 group-hover:text-blue-600 transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
    ...
    <div className="grid lg:grid-cols-2 gap-12">
      ...
      <section id="certs" className="py-32 bg-slate-50/50">
        <div className="container mx-auto px-6">
          <SectionHeader
            ...
            subtitle="Programs and courses that strengthened my foundation."
            icon={<Code size={28} />}
          />
      ...
      <section id="contact" className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <SectionHeader
            title="Let's Connect"
            subtitle="Always open to new projects, ideas, and collaborations."
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                ...
                },
                {
                  ...
                  link: PERSONAL_INFO.leetcode,
                  icon: <Code size={36} />,
                  color: 'hover:text-yellow-600 hover:border-yellow-600'
                },
                {
                  name: 'GeeksForGeeks',
                  link: PERSONAL_INFO.geeksforgeeks,
                  icon: <Terminal size={36} />,
                  color: 'hover:text-green-700 hover:border-green-700'
                }
              ].map((item, idx) => (
                <motion.a
                  key={item.name}
      ...
      <footer className="pt-24 pb-12 bg-white border-t border-slate-50">
        <div className="container mx-auto px-6 text-center">
          <p className="text-slate-400 font-bold text-xs tracking-widest uppercase">
            &copy; {new Date().getFullYear()} THARUNKUMAR K &bull; ALL RIGHTS
            RESERVED
          </p>
        </div>
      </footer>
